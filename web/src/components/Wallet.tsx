    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-gradient-to-br from-emerald-500 to-emerald-700 rounded-3xl p-8 text-black shadow-2xl shadow-emerald-500/20 relative overflow-hidden">
        ...
        <div className="space-y-6">
          <div className="bg-[#0F0F11] border border-zinc-800/50 rounded-2xl p-6">
            ...
            {success && (
              <div className="mb-4 p-3 bg-emerald-500/10 border border-emerald-500/20 rounded-xl flex gap-3 text-emerald-400">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button 
                ...
                className="flex flex-col items-center gap-2 p-4 bg-zinc-900 border border-zinc-800 rounded-2xl hover:border-emerald-500/50 hover:bg-emerald-500/5 transition-all group disabled:opacity-50"
              >
